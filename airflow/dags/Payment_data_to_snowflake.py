...
SNOWFLAKE_DEST_TABLE = "PAYMENT_DETAILS"
...
with DAG(
    ...
    description="Load payment details to snowflake from ARdata s3 files",
    ...
    audit = TriggerDagRunOperator(
        ...
        conf={
            ...
            "desc": "Payment data json file load - {{task_instance.xcom_pull('s3_copy_into_table')}}rows",
        },
    )
